                    ...
                    <div class="card shadow p-3 mb-5 bg-body-tertiary rounded mt-5" style="min-height: 620px;">
                        ...
                        <div class="card-footer bg-transparent">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end m-3">
                                ...
                                <a class="btn btn-danger" type="button" id="btnCancelarTotal" onClick="cancelar();">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512">
                                        <!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <style>
                                            svg {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <select name="condicion-docente" class="form-select" id="condicion-docente">
                                                <option value="0001">Docente UNT</option>
                                                <option value="0002">Invitado Nacional</option>
                                                <option value="0003">Invitado Local</option>
                                                <option value="0004">Invitado Internacional</option>
                                            </select>
                                        </div>
                                        <div class="col-6 mb-3">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-12 row">
                                            ...
                                            <div class="col-7 mb-12" style="display: flex; justify-content: space-between;">
                                                <button disabled class="btn btn-outline-danger" style="height: 90%;" onClick="eliminarGrupo();" id="btn-deleteGrupo"> <i class="fa fa-trash-o"></i> Eliminar grupo</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="">
                                            <button class="btn btn-primary" id="btnGuardarDatosGrupo" onClick="guardarDatosGrupo();" disabled>
                                                <i class="fa fa-save"></i> Guardar
                                            </button>
                                        </div>
                                    </div>
