                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-12 mb-12 row">
                                        ...
                                        <div class="col-7 mb-12" style="display: flex; justify-content: space-between;">
                                            <button class="btn btn-outline-warning" style="height: 90%;"
                                                onClick="agregarGrupo();" id="btn-addGrupo"> <i
                                                    class="fa fa-plus"></i>Agregar grupo</button>
                                        </div>
                                        <div class="col-12">
                                            <br>
                                            <hr>
                                    ...
                                    <div class="col-12 mb-12 row">
                                        ...
                                        <div class="col-7 mb-12" style="display: flex; justify-content: space-between;">
                                            <button disabled class="btn btn-outline-danger" style="height: 90%;"
                                    ...
                                    <div class="">
                                        <button class="btn btn-primary" id="btnGuardarDatosGrupo"
                                            onClick="guardarDatosGrupo();" disabled>
                                            <i class="fa fa-save"></i> Guardar
                                        </button>
                                    </div>
                                </div>
