...
?>
    ...
    <head>
        ...
        <!-- ESTILOS PROPIOS -->
        <link rel="stylesheet" href="../css/styles.css">
        <title>REPORTE DE ASESORIAS</title>
    </head>
    ...
    <body>
        <div class="page-container">
                ...
                <div class="main-content-inner">
                    <div class="card shadow p-3 mb-5 bg-body-tertiary rounded mt-5" style="min-height: 620px;">
                        <div class="card-header bg-transparent d-flex justify-content-between align-items-center text-center">
                            &nbsp;
                            <h3 class="card-title m-3" id="lblTitulo">Reporte de asesorias</h3>
                            &nbsp;
                        </div>
                        <div class="card-body">
                            <div class="card" style="color: #ffffff; background-color:rgba(135, 135, 135, 0.09); border-radius: 18px;">
                                <div class="card-body">
                                    <div class="row d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="col-lg-1 col-md-2 col-6 d-flex align-items-center h-100" style="height: 80px!important;">
                                    ...
                                    <table id="table_asesorias" class="table table-bordered dt-responsive table-hover">
                                        <thead>
                                            <tr class="table-info">
                                                ...
                                                <th class="text-center">MENCIÓN</th>
                                                <th class="text-center">ALUMNO</th>
                                                <th class="text-center">CURSO</th>
                                                <th class="text-center">CICLO</th>
                                                <th class="text-center">CÓDIGO DE ASESOR</th>
                                                <th class="text-center">DOCUMENTO DE ASESOR</th>
            ...
            <!-- SCRIPT DESPACHO -->
            <script src="../../view/js/report/reporte_asesorias.js"></script>
            <!-- SCRIPT TOASTR -->
