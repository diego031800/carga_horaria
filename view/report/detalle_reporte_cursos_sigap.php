...
<head>
    ...
    <title>Reporte de cursos SIGAP</title>
</head>
...
<body>
            ...
            <div class="main-content-inner">
                <div class="card shadow p-3 mb-5 bg-body-tertiary rounded mt-5" style="min-height: 620px;">
                    <div
                        ...
                        &nbsp;
                        <h3 class="card-title m-3" id="lblTitulo">BÚSQUEDA DE CURSOS SIGAP</h3>
                        &nbsp;
                    </div>
                    <div class="card mt-4"
    ...
    <!-- SCRIPT DESPACHO -->
    <script src="../../view/js/report/detalle_reporte_cursos_sigap.js"></script>
