<?php 
  session_start();
  include_once '../../models/report/detallecursosReportSigap.php';
  ...
  $DetalleCursosReportesSigap = new DetalleCursosReportesSigap();
  echo $DetalleCursosReportesSigap->opciones($parametros);
?>