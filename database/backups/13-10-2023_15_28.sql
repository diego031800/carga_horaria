...
-- Tiempo de generación: 13-10-2023 a las 20:27:07
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_getReporteEnvios` (IN `p_sem_id` INT, IN `p_sec_id` INT, IN `p_prg_id` INT)  BEGIN  
	Select 
